<template lang="">
    <svg version="1.1" width='15px' height='20px' id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 490.667 490.667" style="enable-background:new 0 0 490.667 490.667;" xml:space="preserve">
        <path style="fill:#009688;" d="M466.219,237.781L231.552,3.115C229.548,1.115,226.831-0.005,224,0H32
